...
/**
* $Id: about.php,v 1.1 2004/12/19 20:23:16 malanciault Exp $
* Module: SmartPartner
...
class RwbannerAbout
{
	...
	function RwbannerAbout($aboutTitle='About')
	{
		...
		$this->_lang_author_info           = _MI_RWBANNER_AUTHOR_INFO;
		$this->_lang_developer_lead        = _MI_RWBANNER_DEVELOPER_LEAD;
		$this->_lang_developer_contributor = _MI_RWBANNER_DEVELOPER_CONTRIBUTOR;
		$this->_lang_developer_website     = _MI_RWBANNER_DEVELOPER_WEBSITE;
		$this->_lang_developer_email       = _MI_RWBANNER_DEVELOPER_EMAIL;
		$this->_lang_developer_credits     = _MI_RWBANNER_DEVELOPER_CREDITS;
		$this->_lang_module_info           = _MI_RWBANNER_MODULE_INFO;
		$this->_lang_module_status         = _MI_RWBANNER_MODULE_STATUS;
		$this->_lang_module_release_date   = _MI_RWBANNER_MODULE_RELEASE_DATE ;
		$this->_lang_module_demo           = _MI_RWBANNER_MODULE_DEMO;
		$this->_lang_module_support        = _MI_RWBANNER_MODULE_SUPPORT;
		$this->_lang_module_bug            = _MI_RWBANNER_MODULE_BUG;
		$this->_lang_module_submit_bug     = _MI_RWBANNER_MODULE_SUBMIT_BUG;
		$this->_lang_module_feature        = _MI_RWBANNER_MODULE_FEATURE;
		$this->_lang_module_submit_feature = _MI_RWBANNER_MODULE_SUBMIT_FEATURE;
		$this->_lang_module_disclaimer     = _MI_RWBANNER_MODULE_DISCLAIMER;
		$this->_lang_author_word           = _MI_RWBANNER_AUTHOR_WORD;
		$this->_lang_version_history       = _MI_RWBANNER_VERSION_HISTORY;
