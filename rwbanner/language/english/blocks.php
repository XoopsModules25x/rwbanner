...
define('_MB_RWBANNER_OPTION1','Show category:');
...
define('_MB_RWBANNER_OPTION8','Space between banners(cell spacing):');
...
define('_MB_RWBANNER_OPTION16','Type of Display:');
define('_MB_RWBANNER_OPTION16_1','Show after each reload');
define('_MB_RWBANNER_OPTION16_2','Only once per browser session');
define('_MB_RWBANNER_OPTION16_3','Once each X reloads');
define('_MB_RWBANNER_OPTION17','Display frequency (1/frequency):');
define('_MB_RWBANNER_OPTION18','Showing Direction:');
define('_MB_RWBANNER_OPTION18_1','From top to down');
define('_MB_RWBANNER_OPTION18_2','From down to top');
define('_MB_RWBANNER_OPTION19','Left margin (in pixels):');
...
define('_MB_RWBANNER_IMP','HITS');
define('_MB_RWBANNER_IMPRES','HITS LEFT');
define('_MB_RWBANNER_CLIQUES','CLICKS');
...
define('_MB_RWBANNER_BLOCK3_NAME','DHTML Banner');

define('_MB_RWBANNER_CODE','Code');
define('_MB_RWBANNER_IMPRESSIONS','Impressions');
define('_MB_RWBANNER_CLICKS','Clicks');
define('_MB_RWBANNER_CREATION_DATE','Creation Date');
