...
<script type="text/javascript">
    ...
    function showAd() {
        if (adCount < adTime * 10) {
            ...
            adDiv.left = documentWidth - <{$width/2}>+calunit;
            adDiv.top = documentHeight - <{$height/2}>+calunit;
...
<div id="sponsorAdDiv" style="visibility:hidden;">
    <table width="<{$width}>px" height="<{$height}>px" bgcolor="#<{$block.border}>">
        <tr>
            <td>
                <table width="<{$width-5}>px" height="<{$height-5}>px" bgcolor="#<{$block.bgcolor}>">
                    <tr>
                                            ...
                                            <a href="<{$xoops_url}>/modules/<{$module_dir}>/conta_click.php?id=<{$banner.codigo}>" target="<{$banner.target}>">
                                                ...
                                                <{if $banner.swf == 1}>
                                                    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0" width="<{$block.larg}>" height="<{$block.alt}>">
                                                        ...
                                                        <embed src="<{$xoops_url}>/modules/<{$module_dir}>/assets/images/rwbanner.swf"
                                                               FlashVars="alt=<{$block.alt}>&larg=<{$block.larg}>&fps=<{$banner.fps}>&banner=<{$banner.grafico}>&id=<{$banner.codigo}>&url=<{$xoops_url}>/modules/<{$module_dir}>&target=<{$banner.target}>" quality=high
                                                               pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" ; type="application/x-shockwave-flash" width="<{$block.larg}>" height="<{$block.alt}>">
                                                        </embed>
                                                    </object>
                                                <{else}>
