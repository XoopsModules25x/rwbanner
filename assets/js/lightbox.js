...
Lightbox.prototype = {
    ...
    initialize: function () {
        ...
        var objBannerLink = document.createElement("a");
        objBannerLink.setAttribute('id', 'bannerlink');
        objBannerLink.setAttribute('href', bannerLink);
        objBannerLink.setAttribute('target', bannerTarget);
        objHoverNav.appendChild(objBannerLink);

        var objLightboxImage = document.createElement("img");
        objLightboxImage.setAttribute('id', 'lightboxImage');
        objBannerLink.appendChild(objLightboxImage);
